...
function main() {
  ...
  try {
    ...
    if (isDisabled('@jupyterlab/fasta-extension')) {
      disabled.matches.push('@jupyterlab/fasta-extension');
    } else {
      var module = require('@jupyterlab/fasta-extension/');
      var extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@jupyterlab/geojson-extension')) {
      disabled.matches.push('@jupyterlab/geojson-extension');
    } else {
      var module = require('@jupyterlab/geojson-extension/');
      var extension = module.default;
  ...
  try {
    ...
    if (isDisabled('jupyterlab_discovery')) {
      disabled.matches.push('jupyterlab_discovery');
    } else {
      module = require('jupyterlab_discovery/lib/plugin');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@ijmbarr/jupyterlab_spellchecker')) {
      disabled.matches.push('@ijmbarr/jupyterlab_spellchecker');
    } else {
      module = require('@ijmbarr/jupyterlab_spellchecker/');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@jupyterlab/github')) {
      disabled.matches.push('@jupyterlab/github');
    } else {
      module = require('@jupyterlab/github/');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@jupyterlab/katex-extension')) {
      disabled.matches.push('@jupyterlab/katex-extension');
    } else {
      module = require('@jupyterlab/katex-extension/');
      extension = module.default;
